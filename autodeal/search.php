...
<div class="container">
	<div id="primary" class="content-area">
		<div class="page-header">
			<?php if ( have_posts() ) : ?>
				<h1 class="page-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s', 'autodeal' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
			<?php else : ?>
				<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'autodeal' ); ?></h1>
			<?php endif; ?>
		</div>
		<?php
        $sidebar_layout = get_theme_mod( 'autodeal_sidebar_post_layout','right');
	          	...
	          	<div class="col-lg-8 col-md-8">
		            ...
		            <?php if ( have_posts() ) :
						...
						endwhile; // End of the loop.
							...
							<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'autodeal' ); ?></p>
							<?php
								get_search_form();
		            ...
		            <div class="navigation">
		              <?php
		                  ...
		                  the_posts_pagination( array(
		                      'prev_text'          => __( 'Previous page', 'autodeal' ),
		                      'next_text'          => __( 'Next page', 'autodeal' ),
		                      'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'autodeal' ) . ' </span>',
		                  ) );
		              ?>
