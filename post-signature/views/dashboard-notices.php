...
<div class="notice notice-success is-dismissible <?php echo $this->plugin->name; ?>-notice-welcome">
	<p><?php _e( 'Thank you for installing Insert Ads!', $this->plugin->name ); ?> <a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=' . $this->plugin->posttype ) ); ?>">Create</a> your first Signature now.</p>
</div>
