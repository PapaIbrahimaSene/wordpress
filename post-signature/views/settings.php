	                ...
	                <form action="edit.php?post_type=<?php echo $this->plugin->posttype; ?>&page=<?php echo $this->plugin->name; ?>" method="post" class="ins-settings">
		                <div class="postbox">
		                    ...
		                    <div class="inside">
								...
								<p class="description">
									<?php _e( 'By default, Post Signatures are wrapped in a container that has some CSS to aid layout. Developers may wish to use their own CSS, and should check this Exclude CSS option.', $this->plugin->name ); ?>
								</p>
								<p>
