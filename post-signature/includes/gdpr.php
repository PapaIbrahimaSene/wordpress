...
function insert_ads_vi_gdpr_popup_wp_enqueue_style() {
    wp_enqueue_style('insert_ads_vi_gdpr', '/wp-content/plugins/post-signature/css/gdpr.css');
}


function insert_ads_vi_gdpr_popup_wp_enqueue_scripts() {
    wp_enqueue_script('insert_ads_vi_gdpr', '/wp-content/plugins/post-signature/js/gdpr.js');
}
